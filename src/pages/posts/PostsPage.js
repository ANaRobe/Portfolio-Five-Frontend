  ...
  <i className={`fas fa-search ${styles.SearchIcon}`} />
      ...
      <Container className="d-flex justify-content-center">
        <OverlayTrigger placement="top" overlay={<Tooltip>All</Tooltip>}>
          <Badge variant="secondary" className={btnStyles.Button} onClick={() => setCategory(null)}><img src={All} alt="All" height="30" /></Badge> 
        </OverlayTrigger>
        ...
        <OverlayTrigger placement="top" overlay={<Tooltip>Recommendations</Tooltip>}>
          <Badge variant="secondary" className={btnStyles.Button} onClick={() => setCategory("recommendations")}><img src={Recommendations} alt="Recommendations" height="30" /></Badge>
        </OverlayTrigger>
        <OverlayTrigger placement="top" overlay={<Tooltip>Other</Tooltip>}>
          <Badge variant="secondary" className={btnStyles.Button} onClick={() => setCategory("other")}><img src={Other} alt="Other" height="30" /></Badge>
        </OverlayTrigger>
      </Container>
